  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between pt-4 px-4">
        <h4 className="font-bold text-purple-700 text-base">Recent</h4>
        <button className=" text-purple-500 font-semibold">Clear All</button>
      </div>
              ...
              <>
                <Link className="flex grow" to={"/" + search.user.username}>
                  ...
                  <div className="flex flex-col items-start grow">
                    ...
                    <p className="text-purple mt-1">{search.user.full_name}</p>
                  </div>
                </Link>
                <button
